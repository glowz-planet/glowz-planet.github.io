...
const PAGES = [
  { id:'portal',    url:'index.html' },
  { id:'business',  url:'business/index.html' },
  { id:'therapist', url:'therapist/index.html' },
  { id:'customer',  url:'customer/index.html' },
];
const SIZES = [
  { n:'w', w:1440, h:940 },
  { n:'m', w:390,  h:844 },
...
// therapist はタブを全部たたいて、どの画面でも壊れないか見る
{
  ...
  await pg.goto('file://' + ROOT + '/therapist/index.html');
